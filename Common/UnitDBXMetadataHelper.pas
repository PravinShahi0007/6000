...
//;  , IBX.IBDatabase, IBX.IB ,IBX.IBHeader, IBX.IBExternals;
...
procedure CreateDataForPercentageStoreProc(Provider: TDBXDataExpressMetaDataProvider;
  aProcedureName, aGroupByField, aTableName, aSumField: string);
...
const
  aStoreProc : String =
    'Create procedure %s ' + #13#10 +  //JobFinishPercentage,EP2FinishPercentage,FrameFinishPercentage
    'returns( %s Integer, %s Float ) ' + #13#10 +
    'AS ' + #13#10 +
    'BEGIN ' + #13#10 +
    '  FOR  SELECT %s, Sum(%s) as %s FROM %s Group by %s INTO :%s, :%s ' + #13#10 +
    'END';
var
  cmd: TDBXCommand;
begin
  ...
  try
    cmd.CommandType := TDBXCommandTypes.DbxSQL;
    cmd.Text := Format( aStoreProc, [aProcedureName, aGroupByField, aSumField, aGroupByField, aSumField, aSumField, aTableName, aGroupByField, aGroupByField, aSumField]);
    cmd.ExecuteUpdate;
  finally
    cmd.Free
  end;
...
procedure CreateJobFinishPercentageStoreProc(Provider: TDBXDataExpressMetaDataProvider);
const
  aStoreProc : String =
    'Create procedure JobFinishPercentage ' + #13#10 +
    'AS ' + #13#10 +
    ' BEGIN ' + #13#10 +
        'SELECT b.JOBID, Round(COALESCE(Sum(a.ITEMLENGTH),0)' + #13#10 +
        '/Sum(b.LENGTH)*100) as Percentage '                  + #13#10 +
        'FROM FRAMEENTITY b left join ITEMPRODUCTION a '      + #13#10 +
        'on (a.FRAMEID = b.FRAMEID) and (a.ID=b.ID) '         + #13#10 +
        'Group by b.JOBID;'                                   + #13#10 +
    ' End';
var
  cmd: TDBXCommand;
begin
...
procedure CreateEP2FinishPercentageStoreProc(Provider: TDBXDataExpressMetaDataProvider);
const
  aStoreProc : String =
    'Create procedure EP2FinishPercentage ' + #13#10 +
    'AS ' + #13#10 +
    ' BEGIN ' + #13#10 +
        'SELECT b.EP2FILEID,Round(COALESCE(Sum(a.ITEMLENGTH),0)' + #13#10 +
        '/Sum(b.LENGTH)*100) as Percentage  '                    + #13#10 +
        'FROM FRAMEENTITY b left join ITEMPRODUCTION a   '       + #13#10 +
        'on (a.FRAMEID = b.FRAMEID) and (a.ID=b.ID)   '          + #13#10 +
        'Group by b.EP2FILEID;'                                  + #13#10 +
    ' End';
var
  cmd: TDBXCommand;
begin
...
procedure CreateFrameFinishPercentageStoreProc(Provider: TDBXDataExpressMetaDataProvider);
const
  aStoreProc : String =
    'Create procedure EP2FinishPercentage ' + #13#10 +
    'AS ' + #13#10 +
    ' BEGIN ' + #13#10 +
        'SELECT b.FRAMEID, Round(COALESCE(Sum(a.ITEMLENGTH), 0)' + #13#10 +
        '/Sum(b.LENGTH)*100) as Percentage '                     + #13#10 +
        'FROM FRAMEENTITY b left join ITEMPRODUCTION a '         + #13#10 +
        'on (a.FRAMEID = b.FRAMEID) and (a.ID=b.ID) '            + #13#10 +
        'Group by b.FRAMEID;'                                    + #13#10 +
    ' End';
var
  cmd: TDBXCommand;
begin
