...
function InitialDatabase(aConn: TSQLConnection; aDBName : String; aTag : SmallInt = 0) : SmallInt;
...
begin
  ...
  AddUnicodeVarCharColumn(ATable, 'CODE', 50);
  ...
  //TABLE
  ATable := TDBXMetaDataTable.Create;
  ATable.TableName := 'JOBTRANSFER';
  AddInt32Column         (ATable, 'JOBTRANSFERID');
  ...
  AddInt32Column         (ATable, 'FROMROLLFORMERID');
  AddInt32Column         (ATable, 'TOROLLFORMERID');
  AddInt8Column          (ATable, 'STATUSID');
  AddInt32Column         (ATable, 'SITEID');
  AddDateTimeColumn      (ATable, 'ADDEDON');
  Provider.CreateTable(ATable);
  // PRIMARY AND UNIQUE KEY
  AddPrimaryKey(Provider, 'JOBTRANSFER', 'JOBTRANSFERID');
  // AUTO INC TRIGGER
  CreateGenerator(Provider, 'GEN_JOBTRANSFERID');
  CreateAutoIncTrigger(Provider, 'BI_JOBTRANSFERID', 'JOBTRANSFER', 'JOBTRANSFERID', 'GEN_JOBTRANSFERID' );
  ...
  AddInt8Column          (ATable, 'STATUSID');
  AddInt32Column         (ATable, 'SITEID');
  AddInt8Column          (ATable, 'ROLLFORMERID');
  AddInt8Column          (ATable, 'TRANSFERTORFID1');
  AddInt8Column          (ATable, 'TRANSFERTORFID2');
  AddInt8Column          (ATable, 'TRANSFERTORFID3');
  AddInt8Column          (ATable, 'TRANSFERTORFID4');
  AddInt8Column          (ATable, 'TRANSFERTORFID5');
  AddInt8Column          (ATable, 'TRANSFERTORFID6');
  AddDateTimeColumn      (ATable, 'ADDEDON');
  Provider.CreateTable(ATable);
  // PRIMARY AND UNIQUE KEY
...
//    Comm.ExecuteQuery;
//
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO7', 'Demostration Michine '
//                                            , 'ScotRF Panel', '300', 'SCS007', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO8', 'Demostration Michine 8'
//                                            , 'ScotRF Panel', '300', 'SCS008', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO9', 'Demostration Michine 9'
//                                            , 'ScotRF Panel', '300', 'SCS009', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO10', 'Demostration Michine 10'
//                                            , 'ScotRF Panel', '300', 'SCS010', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO11', 'Demostration Michine 11'
//                                            , 'ScotRF Panel', '300', 'SCS011', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO12', 'Demostration Michine 12'
//                                            , 'ScotRF Panel', '300', 'SCS012', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO13', 'Demostration Michine 13'
//                                            , 'ScotRF Panel', '300', 'SCS013', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO14', 'Demostration Michine 14'
//                                            , 'ScotRF Panel', '300', 'SCS014', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO15', 'Demostration Michine 15'
//                                            , 'ScotRF Panel', '300', 'SCS015', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO16', 'Demostration Michine 16'
//                                            , 'ScotRF Panel', '300', 'SCS016', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO17', 'Demostration Michine 17'
//                                            , 'ScotRF Panel', '300', 'SCS017', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO18', 'Demostration Michine 18'
//                                            , 'ScotRF Panel', '300', 'SCS018', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO19', 'Demostration Michine 19'
//                                            , 'ScotRF Panel', '300', 'SCS019', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
//
//    Comm.Text := Format(SQLINSERTROLLFORMER, ['HQDEMO20', 'Demostration Michine 20'
//                                            , 'ScotRF Panel', '300', 'SCS020', '0'
//                                            ,'0' ,'1', '0'
//                                            , QuotedStr(FormatDateTime('dd.mm.yyyy hh:nn',NOW))]);
//    Comm.ExecuteQuery;
