...
const
  ...
  aRFDateInfo = 'RFDateInfo';
  aRollFormer = 'ROLLFORMER';
  aItemProduction = 'ItemProduction';
  aAudit = 'Audit';
  aRFOperation = 'RFOperation';
  aJob = 'Job';
  aJobTransfer = 'JOBTRANSFER';
  aJOBDETAIL = 'JOBDETAIL';
  aEP2File = 'EP2File';
  aFRAME = 'FRAME';
  aFRAMEENTITY = 'FRAMEENTITY';
  aTHINGSONFRAMEENTITY = 'THINGSONFRAMEENTITY';
